 ...
 * Description:  The View Mwnu page shows unauthenticated visitors the
 *               food which can be ordered online. It contains
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="viewMenu.php">Food Menu</a></li>
