 ...
 * Description:  The delete account page is used to delete a customers account and gather 
 *               some feedback from the customer to find out why they chose to delete their account.
-->
...
<div class="container-fluid"> 
  <div class="row">
    <div class="col col-sm-12 content">
      <div class="container">
        <form role="form" method="post" name="frmDelete" action="deleteAction.php">
          <h1>Delete Account</h1><br />

          <label for="msg">We value our customers opinions. Could you please let us know why you have chosen to delete your account</label>&nbsp;(Maximum 500 chars)
          <textarea id="msg" name="msg" placeholder="Write something here ..." maxlength="499" style="height:200px" autofocus></textarea>

				  <button type="submit" class="btn btn-info btn-order" name="submitfeedback" 
                  onClick="return confirm_delete_account()" value="submitfeedback">DELETE ACCOUNT</button>
